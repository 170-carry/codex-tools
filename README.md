...
- 桌面能力：状态栏驻留、自动更新、多语言界面、编辑器联动；Windows 可将额度显示在任务栏左侧、任务栏右侧或系统托盘，并提供五种托盘图标样式。
...
Windows 首次运行新版时会显示额度展示引导。任务栏组件和系统托盘图标至少启用一种，默认额度口径为“一周剩余”；之后可在“设置”中分别调整位置、图标样式和显示口径。如果左侧组件与 Windows 天气小组件冲突，可通过设置页或引导页打开 Windows 任务栏设置并关闭天气小组件。
